...
class Historique
{
    ...
    public function getDateEffectue()
    {
        return $this->dateEffectue;
    }


    public function setIdDonneur($id)
    {
        $this->donneur = $id;
    }

    public function setIdBeneficiaire($id)
    {
    ...
    public function setDateEffectue($date)
    {
        $this->dateEffectue = $date;
    }
}
